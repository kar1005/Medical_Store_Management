            ...
            <div class="col-md-10 bg-white">
                <div class="row">
                    <div class="col-5">
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                <input type="text" class="form-control" placeholder="Medicine Name" aria-label="First name">
                            </div>
                            <div class="col">
                                <input type="text" class="form-control" placeholder="Medicine Price" aria-label="Last name">
                            </div>
                        </div>

                        <div class="row mb-3">
                            <div class="col">
                                <input type="text" class="form-control" placeholder="Medicine Stock" aria-label="First name">
                            </div>
                            <div class="col">
                                <input type="datetime" class="form-control" aria-label="Last name">
                                <!--For Expiry Date -->
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col">
                                <input type="text" class="form-control" placeholder="Medicine Category" aria-label="First name">
                            </div>
